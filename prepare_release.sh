...
echo "" >> $mail_file
echo "The artifacts as well as the debian package are also available here: http://$apache_host/~$asf_username" >> $mail_file
echo "" >> $mail_file
...
echo "  2) NEWS.txt:    $asf_git_repo?p=cassandra.git;a=blob_plain;f=NEWS.text;hb=refs/tags/$release-tentative"
